...
@Component({
  selector: 'app-accept-service-card-details-smoke',
  templateUrl: './accept-service-card-details-smoke.page.html',
  styleUrls: ['./accept-service-card-details-smoke.page.scss'],
})
export class AcceptServiceCardDetailsSmokePage implements OnInit {
  serviceID: any;
  serviceCard: any;
  client: any;
  site: any;
  ...
  constructor(
    ...
    this.http.get(this.url + 'sp-get-accept-service-details-sc.php?serviceID=' + this.serviceID).subscribe((data: any) => {
      console.log(data);
  ...
  ionViewWillEnter(){
    ...
    console.log('Service Smoke Cards Connection Status: ' + this.networkStatus);
  }
  ...
  acceptServiceJob() {
    this.storage.get('currentUser').then((user: any) => {
      ...
      this.http.post(this.url + 'sp-update-service-card-acceptance-2-sc.php', postData).subscribe((data: any) => {
        console.log(data);
