...
export class WireLessPage implements OnInit {
  ...
  async wirelessDevices() {
    ...
    this.sqlite.create({
      ...
      this.database.executeSql(`SELECT * FROM fire_sp_template_device_loops_table WHERE service_type_id=? AND site_id=?`, [this.serviceTypeID, this.siteID])
      .then((res: any) => {
