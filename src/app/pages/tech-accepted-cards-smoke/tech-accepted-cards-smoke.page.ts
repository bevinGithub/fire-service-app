...
@Component({
  selector: 'app-tech-accepted-cards-smoke',
  templateUrl: './tech-accepted-cards-smoke.page.html',
  styleUrls: ['./tech-accepted-cards-smoke.page.scss'],
})
export class TechAcceptedCardsSmokePage implements OnInit {
  serviceID: any;
  serviceCard: any;
  client: any;
  site: any;
