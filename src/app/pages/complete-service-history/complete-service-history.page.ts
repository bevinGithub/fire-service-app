...
@Component({
  selector: 'app-complete-service-history',
  templateUrl: './complete-service-history.page.html',
  styleUrls: ['./complete-service-history.page.scss'],
})
export class CompleteServiceHistoryPage implements OnInit {
  cert: any;
  tech: any;
  staff: any;
  certficateID: any;
