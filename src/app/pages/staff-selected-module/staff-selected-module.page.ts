...
@Component({
  selector: 'app-staff-selected-module',
  templateUrl: './staff-selected-module.page.html',
  styleUrls: ['./staff-selected-module.page.scss'],
})
export class StaffSelectedModulePage implements OnInit {
  url = environment.url;
  moduleID: any;
  module: any;
  moduleName: any;
