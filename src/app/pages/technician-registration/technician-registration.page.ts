...
@Component({
  ...
  templateUrl: './technician-registration.page.html',
  styleUrls: ['./technician-registration.page.scss'],
})
export class TechnicianRegistrationPage implements OnInit {
  staff: any = {};
  staffInfo: any;
  ...
  submitClientRegistration() {
    ...
    this.http.post(this.url + 'process-technician-registration.php', this.staff).subscribe((user: any) => {
      ...
      if(user.status === 'success') {
        ...
        this.router.navigate(['/technician-activation']);
