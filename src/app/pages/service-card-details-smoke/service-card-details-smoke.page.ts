...
@Component({
  selector: 'app-service-card-details-smoke',
  templateUrl: './service-card-details-smoke.page.html',
  styleUrls: ['./service-card-details-smoke.page.scss'],
})
export class ServiceCardDetailsSmokePage implements OnInit {
  public cert: any;
  public tech: any;
  public staff: any;
  certficateID: any;
  ...
  processServiceCard() {
    this.http.post(this.url + 'sp-process-service-certificate-app-sc.php', this.service).subscribe((res: any) => {
      console.log(res);
